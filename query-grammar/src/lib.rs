...
mod tests {
    ...
    fn test_deduplication() {
        ...
        assert_eq!(
            json,
            r#"{"type":"bool","clauses":[[null,{"type":"literal","field_name":null,"phrase":"a","delimiter":"none","slop":0,"prefix":false}],[null,{"type":"literal","field_name":null,"phrase":"a","delimiter":"none","slop":0,"prefix":false}]]}"#
        );
    }
